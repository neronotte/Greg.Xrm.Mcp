...
namespace Greg.Xrm.Mcp.FormEngineer.Server.Resources
{
	...
	public class Docs
	{
		...
		[McpServerResource(MimeType = "text/markdown", Name = "formxml_instructions", Title = "Instructions to be aware of when manipulating Dataverse FormXml", UriTemplate = "docs://instructions_for_formxml"),
		Description("Instructions that can be used to effectively leverage the current MCP server capabilities on manipulating Dataverse tables FormXml."),
		]
